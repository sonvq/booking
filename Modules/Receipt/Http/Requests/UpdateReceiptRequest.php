 ...
 */
class UpdateReceiptRequest extends BaseReceiptRequest
{
    /**
     * @return array
     */
    public function rules()
    {
        ...
        if (!$canChangeStatus && $receipt->status !== Receipt::STATUS_CONFIRMED) {
        ...
        $rules = $this->addCustomRuleForDeductPaymentType($booking, $validationData, $rules, $receipt->id);
