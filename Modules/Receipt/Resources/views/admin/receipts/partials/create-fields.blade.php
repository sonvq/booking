    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group{{ $errors->has('amount') ? ' has-error' : '' }}">
                ...
                {!! Form::text('amount', old('amount'), ['class' => 'form-control', 'placeholder' => trans('receipt::receipts.form.amount')]) !!}
        ...
        <div class="row parent_id_container hidden">
            <div class="col-md-4">
                <div class="form-group {{ $errors->has('parent_id') ? 'has-error' : '' }}">
                    ...
                    {!! Form::select('parent_id', $originalReceipts, old('parent_id') , ['class' => 'selectize-single']) !!}
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group{{ $errors->has('start_date') ? ' has-error' : '' }}">
                ...
                {!! Form::text('start_date', old('start_date'), ['class' => 'form-control has-datepicker', 'placeholder' => trans('receipt::receipts.form.start_date')]) !!}
...
@include('receipt::admin.receipts.partials.javascript', ['editMode' => false])
