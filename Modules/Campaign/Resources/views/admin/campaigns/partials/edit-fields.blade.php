    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                ...
                {!! Form::text('name', $campaign->name, ['class' => 'form-control', 'placeholder' => trans('campaign::campaigns.form.name')]) !!}
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                ...
                {!! Form::textarea('description', $campaign->description, ['class' => 'form-control', 'placeholder' => trans('campaign::campaigns.form.description')]) !!}
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group{{ $errors->has('amount') ? ' has-error' : '' }}">
                ...
                {!! Form::text('amount', $campaign->amount, ['class' => 'form-control', 'placeholder' => trans('campaign::campaigns.form.amount')]) !!}
        ...
        <div class="col-md-4">
            <div class="form-group {{ $errors->has('change') ? 'has-error' : '' }}">
                ...
                {!! Form::select('change', $changes, $campaign->change , ['class' => 'selectize-single']) !!}
        ...
        <div class="col-md-4">
            <div class="form-group {{ $errors->has('type') ? 'has-error' : '' }}">
                ...
                {!! Form::select('type', $types, $campaign->type , ['class' => 'selectize-single']) !!}
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group {{ $errors->has('hotel_id') ? 'has-error' : '' }}">
                ...
                {!! Form::select('hotel_id[]', $hotels, $campaign->hotels()->allRelatedIds(), ['class' => 'selectize-hotel', 'multiple' => 'multiple']) !!}
...
@include('campaign::admin.campaigns.partials.javascript', ['editMode' => true])
