    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                ...
                {!! Form::text('name', $surcharge->name, ['class' => 'form-control', 'placeholder' => trans('surcharge::surcharges.form.name')]) !!}
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                ...
                {!! Form::textarea('description', $surcharge->description, ['class' => 'form-control', 'placeholder' => trans('surcharge::surcharges.form.description')]) !!}
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group{{ $errors->has('price') ? ' has-error' : '' }}">
                ...
                {!! Form::text('price', $surcharge->price, ['class' => 'form-control', 'placeholder' => trans('surcharge::surcharges.form.price')]) !!}
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group{{ $errors->has('amount') ? ' has-error' : '' }}">
                ...
                {!! Form::text('amount', $surcharge->amount, ['class' => 'form-control', 'placeholder' => trans('surcharge::surcharges.form.amount')]) !!}
        ...
        <div class="col-md-4">
            <div class="form-group {{ $errors->has('change') ? 'has-error' : '' }}">
                ...
                {!! Form::select('change', $changes, $surcharge->change , ['class' => 'selectize-single']) !!}
        ...
        <div class="col-md-4">
            <div class="form-group {{ $errors->has('type') ? 'has-error' : '' }}">
                ...
                {!! Form::select('type', $types, $surcharge->type , ['class' => 'selectize-single']) !!}
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group {{ $errors->has('hotel_id') ? 'has-error' : '' }}">
                ...
                {!! Form::select('hotel_id[]', $hotels, $surcharge->hotels()->allRelatedIds() , ['class' => 'selectize-multiple', 'multiple' => 'multiple']) !!}
