                    ...
                    <div class="table-responsive">
                        <table class="data-table table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <th>{{ trans('service::services.table.description') }}</th>
                                <th>{{ trans('service::services.table.price') }}</th>
                                <th>{{ trans('service::services.table.amount') }}</th>
                                <th>{{ trans('service::services.table.change') }}</th>
                                <th>{{ trans('service::services.table.type') }}</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    {{ str_limit($service->description, $limit = 80, $end = '...') }}
                                </td>
                                <td>
                                ...
                                <td>
                                    @if (!empty($service->change) && isset($changes[$service->change]))
                                        {{ $changes[$service->change] }}
                                    @endif
                                </td>
                                <td>
                                    @if (!empty($service->type) && isset($types[$service->type]))
                                        {{ $types[$service->type] }}
                                    @endif
                                </td>
                                <td>
