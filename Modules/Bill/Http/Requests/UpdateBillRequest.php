 ...
 */
class UpdateBillRequest extends BaseBillRequest
{
    /**
     * @return array
     */
    public function rules()
    {
        ...
        if (!$canChangeStatus && $bill->status !== Bill::STATUS_CONFIRMED) {
        ...
        $rules = $this->addCustomRuleForDeductPaymentType($booking, $validationData, $rules, $bill->id);
