    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group {{ $errors->has('payment_type') ? 'has-error' : '' }}">
                ...
                {!! Form::select('payment_type', $paymentTypes, old('payment_type') , ['class' => 'selectize-single selectize-payment-type']) !!}
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group{{ $errors->has('amount') ? ' has-error' : '' }}">
                ...
                {!! Form::text('amount', old('amount'), ['class' => 'form-control', 'placeholder' => trans('bill::bills.form.amount')]) !!}
        ...
        <div class="row parent_id_container hidden">
            <div class="col-md-4">
                <div class="form-group {{ $errors->has('parent_id') ? 'has-error' : '' }}">
                    ...
                    {!! Form::select('parent_id', $originalBills, old('parent_id') , ['class' => 'selectize-single']) !!}
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group {{ $errors->has('status') ? 'has-error' : '' }}">
                ...
                {!! Form::select('status', $statuses, old('status') , ['class' => 'selectize-single selectize-status']) !!}
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group{{ $errors->has('start_date') ? ' has-error' : '' }}">
                {!! Form::label('start_date', trans('bill::bills.form.start_date'), array('class' => 'required')) !!}
                {!! Form::text('start_date', old('start_date'), ['class' => 'form-control has-datepicker', 'placeholder' => trans('bill::bills.form.start_date')]) !!}
...
@include('bill::admin.bills.partials.javascript', ['editMode' => false])
