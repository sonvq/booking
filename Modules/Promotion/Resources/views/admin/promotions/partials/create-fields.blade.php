    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                ...
                {!! Form::text('name', old('name'), ['class' => 'form-control', 'placeholder' => trans('promotion::promotions.form.name')]) !!}
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                ...
                {!! Form::textarea('description', old('description'), ['class' => 'form-control', 'placeholder' => trans('promotion::promotions.form.description')]) !!}
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group{{ $errors->has('amount') ? ' has-error' : '' }}">
                ...
                {!! Form::text('amount', old('amount'), ['class' => 'form-control', 'placeholder' => trans('promotion::promotions.form.amount')]) !!}
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group {{ $errors->has('agency_id') ? 'has-error' : '' }}">
                ...
                {!! Form::select('agency_id[]', $agencies, old('agency_id') , ['class' => 'selectize-multiple', 'multiple' => 'multiple']) !!}
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group {{ $errors->has('campaign_id') ? 'has-error' : '' }}">
                ...
                {!! Form::select('campaign_id', $campaigns, old('campaign_id') , ['class' => 'selectize-campaign']) !!}
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group {{ $errors->has('hotel_id') ? 'has-error' : '' }}">
                ...
                {!! Form::select('hotel_id[]', [], old('hotel_id') , ['class' => 'selectize-hotel', 'multiple' => 'multiple']) !!}
...
@include('promotion::admin.promotions.partials.javascript', ['editMode' => false])
