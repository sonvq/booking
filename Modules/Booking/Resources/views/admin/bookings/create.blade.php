...
@section('content-header')
    <h1>
        {{ trans('booking::bookings.title.create booking') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li><a href="{{ route('admin.booking.booking.index') }}">{{ trans('booking::bookings.title.bookings') }}</a></li>
        <li class="active">{{ trans('booking::bookings.title.create booking') }}</li>
    </ol>
@stop

@section('content')
    {!! Form::open(['route' => ['admin.booking.booking.store'], 'method' => 'post']) !!}
    <div class="row">
        <div class="col-md-12">
            <div class="nav-tabs-custom">
                <div class="tab-content">
                    @include('booking::admin.bookings.partials.create-fields')
