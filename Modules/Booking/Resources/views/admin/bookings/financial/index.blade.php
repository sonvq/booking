...
@section('content-header')
    <h1>
        {{ trans('booking::bookings.title.financial booking') }}
    </h1>
    <ol class="breadcrumb">
...
@section('content')
    {!! Form::open(['route' => ['admin.booking.booking.financial.create'], 'method' => 'post']) !!}
    <div class="row">
        <div class="col-md-12">
    ...
    @if (isset($reports))
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                @else
                    {{ trans('booking::bookings.messages.no_record_for_financial') }}
                @endif
            </div>
        </div>
    @endif
