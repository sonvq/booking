    ...
    <div class="row">
        <div class="col-sm-3">
            <div class="form-group{{ $errors->has('type') ? ' has-error' : '' }}">
                ...
                {!! Form::select('type', $type, $email->type, ['class' => 'selectize-single']) !!}
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class='form-group{{ $errors->has("content") ? ' has-error' : '' }}'>
                ...
                {!! Form::textarea("content", $email->content, ['id' => 'contentEmail', 'class' => '', 'data-slug' => 'source']) !!}
    ...
    <div class="row">
        <div class="col-sm-3">
            <div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
                ...
                {!! Form::select('status', $status, $email->status, ['class' => 'selectize-single']) !!}
