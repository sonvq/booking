...
return [
    'list resource' => 'Danh sách kênh / đại lý',
    'create resource' => 'Tạo kênh / đại lý',
    'edit resource' => 'Sửa kênh / đại lý',
    'destroy resource' => 'Xóa kênh / đại lý',
    'title' => [
        'agencies' => 'Kênh / Đại lý',
        'create agency' => 'Tạo mới một kênh / đại lý',
        'edit agency' => 'Sửa một kênh / đại lý',
    ],
    'button' => [
        'create agency' => 'Tạo mới kênh / đại lý',
    ],
    'table' => [
        'name' => 'Tên',
        'email' => 'E-mail',
